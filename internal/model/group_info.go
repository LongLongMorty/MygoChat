...
type GroupInfo struct {
	...
	Uuid      string                `gorm:"column:uuid;uniqueIndex:idx_uuid_deleted,priority:1;type:char(20);not null;comment:群组唯一id"`
	...
	DeletedAt soft_delete.DeletedAt `gorm:"column:deleted_at;uniqueIndex:idx_uuid_deleted,priority:2;type:bigint;not null;default:0;softDelete:nano;comment:删除时间"`
}
