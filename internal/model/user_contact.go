...
type UserContact struct {
	...
	UserId      string         `gorm:"column:user_id;index;type:char(20);not null;comment:用户唯一id;uniqueIndex:idx_user_contact_pair,priority:1"`
	ContactId   string         `gorm:"column:contact_id;index;type:char(20);not null;comment:对应联系id;uniqueIndex:idx_user_contact_pair,priority:2"`
