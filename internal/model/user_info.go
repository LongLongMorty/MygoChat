...
type UserInfo struct {
	...
	Email         string         `gorm:"column:email;uniqueIndex:idx_email_deleted,priority:1;type:varchar(254);not null;comment:邮箱"`
	...
	Password      string         `gorm:"column:password;type:varchar(60);not null;comment:Bcrypt加密密文"`
	...
	DeletedAt     soft_delete.DeletedAt `gorm:"column:deleted_at;uniqueIndex:idx_email_deleted,priority:2;type:bigint;not null;default:0;softDelete:nano;comment:删除时间"`
