...
func OpenSession(c *gin.Context) {
	...
	openSessionReq.SendId = c.GetString("uuid")
...
func GetUserSessionList(c *gin.Context) {
	...
	message, sessionList, ret := gorm.SessionService.GetUserSessionList(c.GetString("uuid"))
...
func GetGroupSessionList(c *gin.Context) {
	...
	message, groupList, ret := gorm.SessionService.GetGroupSessionList(c.GetString("uuid"))
...
func DeleteSession(c *gin.Context) {
	...
	message, ret := gorm.SessionService.DeleteSession(c.GetString("uuid"), deleteSessionReq.SessionId)
...
func CheckOpenSessionAllowed(c *gin.Context) {
	...
	message, res, ret := gorm.SessionService.CheckOpenSessionAllowed(c.GetString("uuid"), req.ReceiveId)
