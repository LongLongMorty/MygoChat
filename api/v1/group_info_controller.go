...
func CreateGroup(c *gin.Context) {
	...
	createGroupReq.OwnerId = c.GetString("uuid")
...
func LoadMyGroup(c *gin.Context) {
	...
	message, groupList, ret := gorm.GroupInfoService.LoadMyGroup(c.GetString("uuid"))
...
func LeaveGroup(c *gin.Context) {
	...
	message, ret := gorm.GroupInfoService.LeaveGroup(c.GetString("uuid"), req.GroupId)
	JsonBack(c, message, ret, nil)
}
...
func DismissGroup(c *gin.Context) {
	...
	message, ret := gorm.GroupInfoService.DismissGroup(c.GetString("uuid"), req.GroupId)
	JsonBack(c, message, ret, nil)
}
