...
func GetUserList(c *gin.Context) {
	...
	message, userList, ret := gorm.UserContactService.GetUserList(c.GetString("uuid"))
...
func LoadMyJoinedGroup(c *gin.Context) {
	...
	message, groupList, ret := gorm.UserContactService.LoadMyJoinedGroup(c.GetString("uuid"))
...
func DeleteContact(c *gin.Context) {
	...
	message, ret := gorm.UserContactService.DeleteContact(c.GetString("uuid"), deleteContactReq.ContactId)
...
func ApplyContact(c *gin.Context) {
	...
	applyContactReq.OwnerId = c.GetString("uuid")
...
func GetNewContactList(c *gin.Context) {
	...
	message, data, ret := gorm.UserContactService.GetNewContactList(c.GetString("uuid"))
...
func PassContactApply(c *gin.Context) {
	...
	message, ret := gorm.UserContactService.PassContactApply(c.GetString("uuid"), passContactApplyReq.ContactId)
	JsonBack(c, message, ret, nil)
}
...
func RefuseContactApply(c *gin.Context) {
	...
	message, ret := gorm.UserContactService.RefuseContactApply(c.GetString("uuid"), passContactApplyReq.ContactId)
	JsonBack(c, message, ret, nil)
}
...
func BlackContact(c *gin.Context) {
	...
	message, ret := gorm.UserContactService.BlackContact(c.GetString("uuid"), req.ContactId)
	JsonBack(c, message, ret, nil)
}
...
func CancelBlackContact(c *gin.Context) {
	...
	message, ret := gorm.UserContactService.CancelBlackContact(c.GetString("uuid"), req.ContactId)
	JsonBack(c, message, ret, nil)
}
...
func BlackApply(c *gin.Context) {
	...
	message, ret := gorm.UserContactService.BlackApply(c.GetString("uuid"), req.ContactId)
	JsonBack(c, message, ret, nil)
}
